...
import { X, Paperclip, Hash, Heart, Eye, Bookmark, Trash2, Send } from 'lucide-react';

const UserDoubtModal = ({
  selectedDoubt,
  setSelectedDoubt,
  comments,
  newComment,
              ...
              <div className="flex items-center space-x-3">
                <button
                  ...
                  className={`flex items-center space-x-1 transition-colors ${
                    selectedDoubt.isLiked ? 'text-red-500' : 'hover:text-red-500'
                  }`}
                >
                ...
                {(selectedDoubt.author?._id === userId || userRole === 'admin') && (
                  <button
