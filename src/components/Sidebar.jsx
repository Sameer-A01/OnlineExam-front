...
const Sidebar = ({ onCollapseChange }) => {
  ...
  const [isSidebarVisible, setIsSidebarVisible] = useState(false); // State for mobile visibility
            ...
            {itemsToRender.map((item, index) => (
              <li key={index}>
                <NavLink
                  ...
                  onClick={() => setIsSidebarVisible(false)} // Close sidebar on mobile when item is clicked
                  className={({ isActive }) =>
